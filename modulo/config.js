...
const ERROR_REQUIRED_FIELDS = {status: false, status_code: 400, message: 'Existem campos requeridos que não foram preenhidos ou não atendem aos critérios de digitação'}
